...
import EdithVehiculo from "./pages/editPages/EditVehiculo";
import EdithChofer from "./pages/editPages/EditChofer";
import EditarDepositosPage from "./pages/editPages/EditDeposito";
import EditarTransportistasPage from "./pages/editPages/EditTransportista";
import EditarViajePage from "./pages/editPages/EditViajes";
